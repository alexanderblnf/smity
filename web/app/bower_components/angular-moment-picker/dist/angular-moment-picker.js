                    ...
                    $transclude(function ($transElement) {
                        ...
                        if ($attrs['ngModel']) {
                            ...
                            $ctrl.$formatters.push(function (modelValue) {
                                return utility_1.momentToValue(modelValue, $scope.format) || '';
                            });
                            ...
                            $ctrl.$validators.minDate = function (value) {
                                return $scope.validate || !utility_1.isValidMoment(value) || $scope.limits.isAfterOrEqualMin(value);
                            };
                            $ctrl.$validators.maxDate = function (value) {
                                return $scope.validate || !utility_1.isValidMoment(value) || $scope.limits.isBeforeOrEqualMax(value);
                            };
                        }
                        ...
                        $scope.$watch(function () {
                            return utility_1.momentToValue($ctrl.$modelValue, $scope.format);
                            ...
                            if (angular.isFunction($scope.change) && $attrs['change']) {
                                ...
                                $scope.$evalAsync(function () {
                                    return $scope.change({newValue: newModelValue, oldValue: oldModelValue_1});
                                });
                            }
                        });
                        $scope.$watch(function () {
                        ...
                        $scope.$watchGroup([
                            function () {
                                return utility_1.toValue($scope.minDate, $scope.format, $scope.locale);
                            },
                            function () {
                                return utility_1.toValue($scope.maxDate, $scope.format, $scope.locale);
                            }
                        ], function () {
                        ...
                        $scope.$watch(function () {
                            return utility_1.toValue($scope.startDate, $scope.format, $scope.locale);
                        }, function (newViewValue, oldViewValue) {
                            if (newViewValue == oldViewValue)
                                return;
                        ...
                        $scope.input
                            ...
                            .on('keydown', function (e) {
                                return $scope.keyboard && $scope.$evalAsync(function () {
                                        return $scope.view.keydown(e);
                                    });
                            });
                        $scope.contents.on('click', function () {
                            return focusInput();
                        });
        ...
        var MonthView = (function () {
            ...
            MonthView.prototype.render = function () {
                ...
                this.headers = moment.weekdays().map(function (d, i) {
                    return moment().locale(_this.$scope.locale).startOf('week').add(i, 'day').format('dd');
                });
                // return title
