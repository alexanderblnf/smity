module.exports = function (app) {
    ...
    app.get('/devices/:city', function (req, res) {
    ...
    app.get('/devices/online/:city', function (req, res) {
        var city = req.params.city;
        var options = {
            headers: uradHeaders,
            host: 'data.uradmonitor.com',
    ...
    app.get('/:device/co2/:interval', function (req, res) {
        var device = req.params.device;
        var interval = req.params.interval;
        var options = {
            headers: uradHeaders,
    ...
    app.get('/:device/ch2o/:interval', function (req, res) {
        var device = req.params.device;
        var interval = req.params.interval;
        var options = {
            headers: uradHeaders,
